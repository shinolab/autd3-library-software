...
namespace libsoem
{
	...
	constexpr uint32_t SYNC0_CYCLE_TIME_MILLI_SEC = static_cast<uint32_t>(MOD_BUF_SIZE * 1000 / MOD_SAMPLING_FREQUENCY);
	constexpr uint32_t SYNC0_CYCLE_TIME_NANO_SEC = SYNC0_CYCLE_TIME_MILLI_SEC * 1000 * 1000;
