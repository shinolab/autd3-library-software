...
using OnLostCallback = void (*)(const char*);
...
EXPORT_AUTD void AUTDLinkSOEM(void** out, const char* ifname, int32_t device_num, uint32_t cycle_ticks, OnLostCallback callback);
}
