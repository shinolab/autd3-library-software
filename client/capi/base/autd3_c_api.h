...
EXPORT_AUTD bool AUTDUpdateCtrlFlags(const void* handle);
EXPORT_AUTD bool AUTDSetOutputDelay(const void* handle, const uint8_t* delay);
EXPORT_AUTD bool AUTDSetDutyOffset(const void* handle, const uint8_t* offset);
EXPORT_AUTD bool AUTDSetDelayOffset(const void* handle, const uint8_t* delay, const uint8_t* offset);
...
EXPORT_AUTD bool AUTDStop(const void* handle);
EXPORT_AUTD bool AUTDPause(const void* handle);
EXPORT_AUTD bool AUTDResume(const void* handle);
EXPORT_AUTD bool AUTDSendGain(const void* handle, const void* gain, bool wait_for_msg_processed);
EXPORT_AUTD bool AUTDSendModulation(const void* handle, const void* mod);
EXPORT_AUTD bool AUTDSendGainModulation(const void* handle, const void* gain, const void* mod, bool wait_for_msg_processed);
EXPORT_AUTD bool AUTDSendSequence(const void* handle, const void* seq);
EXPORT_AUTD bool AUTDSendGainSequence(const void* handle, const void* seq);
